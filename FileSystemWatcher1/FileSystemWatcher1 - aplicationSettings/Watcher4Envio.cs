    ...
    public class Watcher4Envio
    {
        ...
        */
        ...
        private void HaceEnvioTCP(String sFullPath, String sName)
        {
            ...
            try
            {
                ...
                if (MueveArch(sFullPath, sFileTemp, ref sMsg))
                {
                    ...
                    EnvioTCP oEnvioTCP = new EnvioTCP(this.IPDest, this.PortDest, sName, oLog);
        ...
        public string LogPathXML
        {
            get
            {
                return this.sLogPathXML;
            }
            set
            {
                this.sLogPathXML = value;
            }
        }
